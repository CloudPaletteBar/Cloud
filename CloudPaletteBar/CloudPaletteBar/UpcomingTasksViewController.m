...
@interface UpcomingTasksViewController ()<UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate>{
...
- (void)viewDidLoad {
    ...
    self.baseTableView.frame=CGRectMake(0, 44, screen_width, screen_height-64-88);
...
-(void)netWork:(int)page{
    ...
    [ NetworkManager requestWithMethod:@"POST" bodyParameter:@{@"taskName":seachBar.text,@"taskType":@"2",@"pageNo":[NSString stringWithFormat:@"%d",page],@"pageSize":@"10"} relativePath:@"appAction!myTask.chtml" success:^(id responseObject) {
