...
@interface AllTasksViewController ()<UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate>{
...
-(void)netWork:(int)page{
    ...
    [ NetworkManager requestWithMethod:@"POST" bodyParameter:@{@"taskName":seachBar.text,@"taskType":@"0",@"pageNo":[NSString stringWithFormat:@"%d",page],@"pageSize":@"10"} relativePath:@"appAction!myTask.chtml" success:^(id responseObject) {
